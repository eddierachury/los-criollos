 ...
 public $field_defaults = [
	...
	public function render_content() {
		...
		if ( $this->field['background-image'] === true ) {
			...
			$placeholder = $this->field['placeholder'] ?? __( 'No media selected', 'style-manager' );
			...
			echo '<span class="button background_upload_button" id="' . esc_attr( $this->id ) . '-media" data-setting_id="' . esc_attr( $this->setting->id ) . '" >' . esc_html__( 'Upload', 'style-manager' ) . '</span>';
			...
			echo '<span class="button remove-image' . $hide . '" id="reset_' . esc_attr( $this->id ) . '" rel="' . esc_attr( $this->id ) . '">' . esc_html__( 'Remove', 'style-manager' ) . '</span>';
		...
		if ( $this->field['background-repeat'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-repeat'], '', false ) . '>' . esc_html__( 'Background repeat..', 'style-manager' ) . '</option>';
		...
		if ( $this->field['background-clip'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-clip'], '', false ) . '>' . esc_html__( 'Background clip..', 'style-manager' ) . '</option>';
			foreach ( $array as $k => $v ) {
		...
		if ( $this->field['background-origin'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-origin'], '', false ) . '>' . esc_html__( 'Background origin..', 'style-manager' ) . '</option>';
			foreach ( $array as $k => $v ) {
		...
		if ( $this->field['background-size'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-size'], '', false ) . '>' . esc_html__( 'Background size..', 'style-manager' ) . '</option>';
			foreach ( $array as $k => $v ) {
		...
		if ( $this->field['background-attachment'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-attachment'], '', false ) . '>' . esc_html__( 'Background attachment..', 'style-manager' ) . '</option>';
			foreach ( $array as $k => $v ) {
		...
		if ( $this->field['background-position'] === true ) {
			...
			echo '<option disabled ' . selected( $this->value['background-position'], '', false ) . '>' . esc_html__( 'Background position..', 'style-manager' ) . '</option>';
			foreach ( $array as $k => $v ) {
