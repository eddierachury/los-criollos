...
class Fonts {
	 ...
	 * @return string
	 */
	public static function cleanupWhitespace( $string ): string {
	 ...
	 * @return array
	 */
	public static function maybeExplodeList( $str, $delimiter = ',' ): array {
	 ...
	 * @return string
	 */
	public static function maybeImplodeList( $value, $delimiter = ',' ): string {
	 ...
	 * @return string
	 */
	public static function standardizeSourceFontFamily( $fontFamily ): string {
	 ...
	 * @return array
	 */
	public static function extractAllowedCSSPropertiesFromFontFields( $subfields ): array {
	...
	public static function getValidSubfieldValues( $subfield, $labels = false ) {
		$valid_values = apply_filters( 'style_manager/fonts_valid_subfield_values', [
			'text_align'      => [
				'initial' => esc_html__( 'Initial', 'style-manager' ),
				'center'  => esc_html__( 'Center', 'style-manager' ),
				'left'    => esc_html__( 'Left', 'style-manager' ),
				'right'   => esc_html__( 'Right', 'style-manager' ),
			],
			'text_transform'  => [
				'none'       => esc_html__( 'None', 'style-manager' ),
				'capitalize' => esc_html__( 'Title Case', 'style-manager' ),
				'uppercase'  => esc_html__( 'UPPERCASE', 'style-manager' ),
				'lowercase'  => esc_html__( 'lowercase', 'style-manager' ),
			],
			'text_decoration' => [
				'none'         => esc_html__( 'None', 'style-manager' ),
				'underline'    => esc_html__( 'Underline', 'style-manager' ),
				'overline'     => esc_html__( 'Overline', 'style-manager' ),
				'line-through' => esc_html__( 'Line Through', 'style-manager' ),
			],
		] );
	 ...
	 * @return string
	 */
	public static function convertFontVariantsToGoogleFontsCSS2Styles( $variants ): string {
		$stylesString = '';
		if ( ! is_array( $variants ) || empty( $variants ) ) {
			return $stylesString;
		}
