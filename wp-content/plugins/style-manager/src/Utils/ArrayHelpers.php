...
class ArrayHelpers {
	 ...
	 * @return array
	 */
	public static function insertBeforeKey( $array, $key, $insert ): array {
	 ...
	 * @return array
	 */
	public static function insertAfterKey( $array, $key, $insert ): array {
		$keys  = array_keys( $array );
		$index = array_search( $key, $keys );
	 ...
	 * @return array
	 */
	public static function reorder( $array, $old_index, $new_index ): array {
		array_splice(
			$array,
			$new_index,
			count( $array ),
