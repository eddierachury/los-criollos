...
class CloudFonts extends AbstractHookProvider {
  ...
  * @param mixed[] $fonts
  */
 protected function add_cloud_fonts_to_font_selector( $fonts ): array {
		if ( empty( $fonts ) ) {
			$fonts = [];
		}
  ...
  * @param mixed[] $fonts
  */
 protected function add_cloud_system_fonts_to_font_selector( $fonts ): array {
		if ( empty( $fonts ) ) {
			$fonts = [];
		}
	 ...
	 * @return array
	 */
	protected function preprocess_font_config( $font_config ): array {
