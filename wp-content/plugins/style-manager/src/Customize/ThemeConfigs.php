...
class ThemeConfigs extends AbstractHookProvider {
	 ...
	 * @return array
	 */
	protected function maybe_activate_external_theme_config( $config ): array {
	 ...
	 * @return array
	 */
	protected function maybe_apply_external_theme_config( $config ): array {
	 ...
	 *
	 */
	protected function maybe_process_external_theme_config_extras( $wp_customize ) {
		// Bail if we have no external theme config data.
		if ( empty( $this->external_theme_config ) ) {
			return;
		}
