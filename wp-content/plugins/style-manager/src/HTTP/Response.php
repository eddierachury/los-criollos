...
class Response {
	 ...
	 * @return Response
	 */
	public static function for_file( $filename ): Response {
		$headers = [
			'Robots'                    => 'none',
	 ...
	 * @return Response
	 */
	public static function from_exception( $e ): Response {
		$status_code = 500;
		$headers     = [];
	 ...
	 */
	protected static function error_to_response( $error ): WP_REST_Response {
