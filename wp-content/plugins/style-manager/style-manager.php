		...
		<p>
			...
			printf(
				wp_kses( /* translators: %1$s - WordPress.org for recommended WordPress hosting. */
					__( 'Your site is running an <strong>old version</strong> of PHP that is no longer supported. Please contact your web hosting provider to update your PHP version or switch to a <a href="%1$s" target="_blank" rel="noopener noreferrer">recommended WordPress hosting company</a>.', 'style-manager' ),
					array(
						'a'      => array(
							'href'   => array(),
							'target' => array(),
			...
			printf(
				wp_kses( /* translators: %s - WordPress.org requirements URL with more details. */
					__( '<strong>The Style Manager plugin is disabled</strong> on your site until you fix the issue. <a href="%s" target="_blank" rel="noopener noreferrer">Read more for additional information.</a>', 'style-manager' ),
					array(
						'a'      => array(
							'href'   => array(),
							'target' => array(),
