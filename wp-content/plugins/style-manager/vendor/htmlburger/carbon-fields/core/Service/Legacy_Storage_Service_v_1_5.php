...
class Legacy_Storage_Service_v_1_5 extends Service {
	 ...
	 * @return Container
	 */
	protected function get_container_for_datastore( $datastore ) {
	 ...
	 * @return array
	 */
	protected function get_table_details_for_datastore( $datastore ) {
		global $wpdb;
	 ...
	 * @return array<string>
	 */
	protected function get_legacy_sql_comparisons_for_field( $field, $key_prefix, $key_column ) {
	 ...
	 * @return array
	 */
	protected function get_legacy_storage_array_from_database( $container, $datastore ) {
		global $wpdb;
	 ...
	 * @return array
	 */
	public function get_legacy_storage_array( $datastore ) {
	 ...
	 * @return array
	 */
	public function get_storage_array_for_datastore( $datastore ) {
	 ...
	 * @return array
	 */
	public function get_storage_array( $datastore, $storage_key_patterns ) {
