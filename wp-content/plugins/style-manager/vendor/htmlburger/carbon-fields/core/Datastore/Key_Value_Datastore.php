...
abstract class Key_Value_Datastore extends Datastore {
	 ...
	 * @return array<string>
	 */
	protected function get_full_hierarchy_for_field( $field ) {
	 ...
	 * @return array<int>
	 */
	protected function get_full_hierarchy_index_for_field( $field ) {
	 ...
	 * @return array
	 */
	protected function value_tree_array_to_value_tree( $value_tree_array, $field ) {
	 ...
	 */
	abstract protected function get_storage_array( $field, $storage_key_patterns );
