...
abstract class Translator {
	 ...
	 * @return mixed
	 */
	public function fulfillable_to_foreign( $fulfillable ) {
	 ...
	 * @return mixed
	 */
	abstract protected function condition_to_foreign( $condition );
	 ...
	 * @return mixed
	 */
	abstract protected function fulfillable_collection_to_foreign( $fulfillable_collection );
