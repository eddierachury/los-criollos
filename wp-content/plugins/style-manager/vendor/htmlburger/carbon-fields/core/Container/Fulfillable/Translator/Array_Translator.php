...
class Array_Translator extends Translator {
	...
	/**
  * {@inheritDoc}
  * @param \Carbon_Fields\Container\Condition\Condition $condition
  */
 protected function condition_to_foreign( $condition ) {
		return array(
	...
	/**
  * {@inheritDoc}
  * @param \Carbon_Fields\Container\Fulfillable\Fulfillable_Collection $fulfillable_collection
  */
 protected function fulfillable_collection_to_foreign( $fulfillable_collection ) {
