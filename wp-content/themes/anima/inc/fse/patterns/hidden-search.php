 ...
 */
return [
	'title'    => __( 'Search content (theme)', 'anima' ),
	'inserter' => false,
...
<h1 class="has-larger-font-size" id="search-results">' . esc_html__( 'Search results', 'anima' ) . '</h1>
<!-- /wp:heading -->

<!-- wp:search {"label":"' . esc_html__( 'Search', 'anima' ) . '","showLabel":false,"width":null,"widthUnit":"%","buttonText":"' . esc_html__( 'Search', 'anima' ) . '"} /--></div>
<!-- /wp:group -->',
];
