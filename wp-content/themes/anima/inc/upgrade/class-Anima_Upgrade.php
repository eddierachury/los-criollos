...
class Anima_Upgrade {
	...
	public function notice_new_version() {
		...
		foreach ( $this->new_versions as $new_version ) {
			echo '<div class="notice notice-success is-dismissible"><p>' .
			     sprintf( __( 'Your <strong>%s</strong> theme has been updated to <strong>version %s.</strong> Enjoy!', 'anima' ), $this->theme_name, $new_version ) .
			     '</p></div>';
		}
	}
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__,esc_html__( 'You should not do that!', 'anima' ), null );
	}
