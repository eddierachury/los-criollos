...
function anima_add_fonts_section_to_style_manager_config( $config ) {
	...
	$anima_fonts_section = [
		'fonts_section' => [
			'title'   => esc_html__( 'Fonts', 'anima' ),
			'options' => [
				'main_content_title_body_fonts_section' => [
					'type' => 'html',
					'html' => '<span class="separator sub-section label">' . esc_html__( 'Body Fonts', 'anima' ) . '</span>',
				],
				'body_font'    => [
					'type'              => 'font',
					'label'             => esc_html__( 'Body', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'lead_font'    => [
					'type'              => 'font',
					'label'             => esc_html__( 'Lead Paragraphs', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'main_content_title_heading_fonts_section' => [
					'type' => 'html',
					'html' => '<span class="separator sub-section label">' . esc_html__( 'Heading Fonts', 'anima' ) . '</span>',
				],
				'super_display_font'    => [
					'type'              => 'font',
					'label'             => esc_html__( 'Super Display', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'display_font'    => [
					'type'              => 'font',
					'label'             => esc_html__( 'Display', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_1_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 1', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_2_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 2', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_3_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 3', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_4_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 4', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_5_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 5', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'heading_6_font'  => [
					'type'              => 'font',
					'label'             => esc_html__( 'Heading 6', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'headline_lines_spacings'   =>  [
					'type'        => 'range',
					'label'       => esc_html__( 'Headline Lines Spacing', 'anima' ),
					'desc'        => esc_html__( 'The vertical distance between primary and secondary titles.', 'anima' ),
					'live'        => true,
					'default'     => -0.3,
					'input_attrs' => [
						'min'          => -1,
				...
				'main_content_title_other_fonts_section' => [
					'type' => 'html',
					'html' => '<span class="separator sub-section label">' . esc_html__( 'Other Fonts', 'anima' ) . '</span>',
				],
				'site_title_font' => [
					'type'              => 'font',
					'label'             => esc_html__( 'Site Title', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'navigation_font' => [
					'type'              => 'font',
					'label'             => esc_html__( 'Navigation', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
				...
				'buttons_font' => [
					'type'              => 'font',
					'label'             => esc_html__( 'Buttons', 'anima' ),
					'desc'              => esc_html__( '', 'anima' ),
					'selector'          => ':root',
