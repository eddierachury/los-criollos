		...
		[
			'options' => [
				...
				'sm_fonts_connected_fields_preset' => [
					...
					'choices' => [
						'preset-1'      => [
							'label'   => esc_html__( 'Preset 1 (Towards Primary)', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [
									'super_display_font',
						...
						'preset-1-5-0'      => [
							'label'   => esc_html__( 'Preset 1.5', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [
									'super_display_font',
						...
						'preset-2'      => [
							'label'   => esc_html__( 'Preset 2 (Default)', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [
									'super_display_font',
						...
						'preset-2-5'      => [
							'label'   => esc_html__( 'Preset 2.5', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [
									'super_display_font',
						...
						'preset-3'      => [
							'label'   => esc_html__( 'Preset 3 (Towards Secondary/Body)', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [
									'super_display_font',
						...
						'preset-body'   => [
							'label'   => esc_html__( 'Misc: All Body', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [],
								'sm_font_secondary' => [],
						...
						'preset-accent' => [
							'label'   => esc_html__( 'Misc: All Accent', 'anima' ),
							'options' => [],
							'config'  => [
								'sm_font_primary'   => [],
								'sm_font_secondary' => [],
