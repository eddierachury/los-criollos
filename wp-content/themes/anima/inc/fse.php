		...
		foreach ( $query_result as $template ) {
			...
			switch ( $template->slug ) {
				case 'archive-product':
					$template->title = esc_html__( 'Products Archive', 'anima' );
					$template->description = esc_html__( 'Displays the entire products list.', 'anima' );
					break;
				case 'taxonomy-product_cat':
					$template->title = esc_html__( 'Product Categories Archive', 'anima' );
					$template->description = esc_html__( 'Displays the products from a certain product category.', 'anima' );
					break;
				case 'taxonomy-product_tag':
					$template->title = esc_html__( 'Product Tags Archive', 'anima' );
					$template->description = esc_html__( 'Displays the products with a certain product tag attached.', 'anima' );
					break;
				case 'single-product':
					$template->title = esc_html__( 'Single Product', 'anima' );
					$template->description = esc_html__( 'Displays a single product.', 'anima' );
					break;
				case 'single-split-header':
					$template->description = esc_html__( 'Displays a single post with a different layout for the header.', 'anima' );
					break;
				
				// Single
				case 'single-testimonial':
					$template->description = esc_html__( 'Displays a single testimonial.', 'anima' );
					break;
				case 'single-portfolio':
					$template->description = esc_html__( 'Displays a single project.', 'anima' );
					break;
				case 'single-gallery':
					$template->description = esc_html__( 'Displays a single gallery.', 'anima' );
					break;
				
				// Archive
				case 'archive-testimonial':
					$template->description = esc_html__( 'Displays the entire testimonials list.', 'anima' );
					break;
				case 'archive-portfolio':
					$template->description = esc_html__( 'Displays the entire projects list.', 'anima' );
					break;
				case 'archive-gallery':
					$template->description = esc_html__( 'Displays the entire galleries list.', 'anima' );
					break;
				
				// Tag
				case 'taxonomy-testimonial_tag':
					$template->description = esc_html__( 'Displays the testimonials with a certain tag attached.', 'anima' );
					break;
				case 'taxonomy-portfolio_tag':
					$template->description = esc_html__( 'Displays the projects with a certain tag attached.', 'anima' );
					break;
				case 'taxonomy-gallery_tag':
					$template->description = esc_html__( 'Displays the galleries with a certain tag attached.', 'anima' );
					break;
				
				// Type
				case 'taxonomy-testimonial_type':
					$template->description = esc_html__( 'Displays the testimonials with a certain type attached.', 'anima' );
					break;
				case 'taxonomy-portfolio_type':
					$template->description = esc_html__( 'Displays the projects with a certain type attached.', 'anima' );
					break;
				case 'taxonomy-gallery_type':
					$template->description = esc_html__( 'Displays the galleries with a certain type attached.', 'anima' );
					break;
				default:
					break;
			}
