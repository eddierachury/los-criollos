	...
	class Anima_Admin_Customize {
		...
		public function customize_register( WP_Customize_Manager $wp_customize ) {
			...
			$wp_customize->add_control( new WP_Customize_Cropped_Image_Control( $wp_customize, 'anima_transparent_logo',
				[
					'label' => esc_html__( 'Logo while on Transparent Header', 'anima' ),
					'button_labels' => [
						'select'       => esc_html__( 'Select logo', 'anima' ),
						'change'       => esc_html__( 'Change logo', 'anima' ),
						'default'      => esc_html__( 'Default', 'anima' ),
						'remove'       => esc_html__( 'Remove', 'anima' ),
						'placeholder'  => esc_html__( 'No logo selected', 'anima' ),
						'frame_title'  => esc_html__( 'Select logo', 'anima' ),
						'frame_button' => esc_html__( 'Choose logo', 'anima' ),
					],
