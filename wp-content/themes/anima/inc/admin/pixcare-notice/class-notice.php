...
class PixelgradeCare_Install_Notice {
	...
	public function outputMarkup() {
		$button_text = __( 'Install the Pixelgrade Care&reg; plugin', 'anima' );
		...
		if ( ! class_exists( 'PixelgradeCare' ) && file_exists( WP_PLUGIN_DIR . '/pixelgrade-care/pixelgrade-care.php' ) ) {
			$button_text = __( 'Activate the Pixelgrade Care&reg; plugin', 'anima' );
		} elseif ( class_exists( 'PixelgradeCare' ) ) {
			// The plugin is actually active.
			$button_text = __( 'Start the Pixelgrade Care&reg; setup', 'anima' );
		}
		...
		<div class="pixcare-notice__container notice is-dismissible" >
			...
			<ul class="pxg-wizard">
				<li class="pxg-wizard__step pxg-wizard__step--done">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Theme', 'anima' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step pxg-wizard__step--current">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Pixelgrade Care&reg;', 'anima' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Site setup', 'anima' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Ready!', 'anima' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
			</ul>
				...
				<div class="pixcare-notice__wrap">
					...
					<div class="pixcare-notice__body">
						<h1><?php
							...
							echo wp_kses( sprintf( __( 'Thanks for installing %s, you\'re awesome!<br>Let\'s make an experience out of it.', 'anima' ),  $theme->get( 'Name' ) ), wp_kses_allowed_html('post') ); ?></h1>
						<p><?php echo wp_kses( __('We\'ve prepared a special onboarding setup that helps you get started and configure your upcoming website in style. Let\'s make it shine!', 'anima' ), wp_kses_allowed_html('post') ); ?></p>
						<ul>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Recommended plugins</strong> to boost your site.', 'anima' ), wp_kses_allowed_html() ); ?></span>
							</li>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Starter Content</strong> to make your site look like the demo.', 'anima' ), wp_kses_allowed_html() ); ?></span>
							</li>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Premium Support</strong> to assist you all the way.', 'anima' ), wp_kses_allowed_html() ); ?></span>
							</li>
						</ul>
						...
						<noscript>
							<button type="submit" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'anima' ); ?></span></button>
						</noscript>
					</div>
				</div>
	...
	public function outputJS() {
		...
		wp_localize_script( 'pixcare_notice_js', 'pixcareNotice', [
			...
			'i18n' => [
				'btnInstall' => esc_html__( 'Install the Pixelgrade Care&reg; plugin', 'anima' ),
				'btnInstalling' => esc_html__( 'Installing Pixelgrade Care&reg;...', 'anima' ),
				'btnActivate' => esc_html__( 'Activate the Pixelgrade Care&reg; plugin', 'anima' ),
				'btnActivating' => esc_html__( 'Activating Pixelgrade Care&reg;...', 'anima' ),
				'btnOpenSetup' => esc_html__( 'Start the Pixelgrade Care&reg; setup', 'anima' ),
				'btnOpeningSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup...', 'anima' ),
				'btnRedirectingToSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup...', 'anima' ),
				'btnError' => esc_html__( 'Please refresh the page 🙏 and try again...', 'anima' ),
				'installedSuccessfully' => esc_html__( 'Plugin installed successfully.', 'anima' ),
				'activatedSuccessfully' => esc_html__( 'Plugin activated successfully.', 'anima' ),
				'redirectingToSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup in a couple of seconds.', 'anima' ),
				'folderAlreadyExists' => esc_html__( 'Plugin destination folder already exists.', 'anima' ),
				'error' => esc_html__( 'We are truly sorry 😢 Something went wrong and we couldn\'t make sense of it and continue with the plugin setup.', 'anima' ),
			],
		] );
	}
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cheatin&#8217; huh?', 'anima' ) ), null );
	}
