...
if ( ! function_exists( 'anima_setup' ) ) {
	...
	function anima_setup() {
		 ...
		 * to change 'anima' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( [
			'primary'            => esc_html__( 'Primary Menu', 'anima' ),
			'secondary'          => esc_html__( 'Secondary Menu', 'anima' ),
			'tertiary'          => esc_html__( 'Tertiary Menu', 'anima' ),
			'search-suggestions' => esc_html__( 'Search Suggestions', 'anima' )
		] );
...
function anima_widgets_init() {
	...
	register_sidebar(
		[
			'name'          => esc_html__( 'Article Sidebar', 'anima' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here to appear next to your articles.', 'anima' ),
